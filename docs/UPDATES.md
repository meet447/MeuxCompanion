...
|----------|---------------|-------|
| macOS (Apple Silicon) | `.app.tar.gz` | Not signed or notarized. First install: `xattr -c /Applications/Meuxe.app`. Code signing + notarization improves first-run and update UX. |

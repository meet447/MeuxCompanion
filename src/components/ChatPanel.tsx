...
// ⚡ Bolt: Extracting the input state into an isolated ChatInput component
// prevents the entire ChatPanel (and all MessageBubbles) from unnecessarily
// re-rendering on every keystroke. This improves typing responsiveness and
// reduces overall React render overhead in large chats.

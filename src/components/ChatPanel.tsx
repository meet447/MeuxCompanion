...
// Extracted into a separate component to isolate the text input state.
// This prevents ChatPanel (and its O(N) message element iterations)
// from re-rendering and executing VDOM diffs on every keystroke.

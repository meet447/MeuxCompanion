...
def is_configured(model_id: str):
    ...
    if model_mapping_path.exists():
        try:
            ...
            if emotions:
                neutral_expr = emotions.get("neutral", {}).get("expression", "neutral")
                return {"configured": True, "neutral": neutral_expr}
